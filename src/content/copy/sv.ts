  ...
  articleCopy: {
    ...
    "google-business-profiili": {
      ...
      body: [
        ...
        { h: "Kategorier och tjänster, inte bara grunduppgifterna" },
        { p: "Huvudkategorin avgör vilka sökningar du överhuvudtaget kan synas för, och de flesta företag väljer något ungefär rätt i stället för exakt rätt. En byggfirma som mest gör takrenoveringar konkurrerar i fel kategori om just de taksökningar som faktiskt skulle bli kunder." },
        { p: "Tjänstelistan under kategorin är nästan lika viktig. När varje tjänst är namngiven med precis de ord en kund faktiskt söker på, får Google mer att matcha mot än vad en enda kategori någonsin ger." },
        { h: "Profilen glider fel om ingen ser efter" },
        { p: "Säsongsöppettider, en tillfällig stängning, en ny tjänst: inget av det uppdaterar sig själv. De företag som syns rätt är de som behandlar profilen som något som sköts löpande, inte något som sätts upp en gång." },
        { p: "Frågor och svar-avsnittet är också värt att kontrollera. Vem som helst kan skriva en fråga där, och vem som helst kan svara på den, även någon utan koppling till ditt företag. En obesvarad eller fel besvarad fråga ligger kvar högst upp i din profil tills någon rättar den." },
      ],
    ...
    "sivuston-nopeus": {
      ...
      body: [
        ...
        { h: "Typsnitt är en dold kostnad" },
        { p: "En sida som laddar ett typsnitt från en extern leverantör gör, utöver allt annat, ännu en separat nätverksförfrågan till en server som inte har något med ditt företag att göra. När typsnittet i stället laddas från er egen server tillsammans med resten av webbplatsen försvinner den förfrågan helt, och webbläsaren kan visa texten snabbare." },
        { p: "Samma sak gäller inbäddade widgetar: en chattbubbla, en bokningskalender, ett flöde från sociala medier. Var och en av dem är en liten webbplats som laddas inuti din egen, och var och en har sin egen hastighetsbudget som läggs till din totala, oavsett om du bad om det eller inte." },
        { h: "Varför plattformen under spelar roll" },
        { p: "En sida byggd av statiska filer kan levereras på millisekunder, eftersom ingen databasfråga eller serverrendering sker just när någon besöker sidan. Ett publiceringssystem gör samma arbete vid varje enskild förfrågan, om det inte särskilt satts upp för cachning, och det har de flesta småföretags installationer inte." },
        { p: "Det här är inget argument mot varje system. Det är ett skäl att fråga, innan bygget börjar, vad som faktiskt händer på servern när en besökare laddar en sida, för det svaret förutspår din laddningstid bättre än nästan något annat i offerten." },
      ],
    ...
    "evasteeton-analytiikka": {
      ...
      body: [
        ...
        { h: "Vad lagen faktiskt kräver" },
        { p: "Förordningen kräver ingen banner. Den kräver samtycke innan annan än nödvändig behandling sker, oftast spårningskakor som följer en besökare mellan webbplatser. Bannern är bara det vanligaste sättet att inhämta det samtycket, ingen ruta som måste kryssas oavsett vad webbplatsen faktiskt gör." },
        { p: "Ett verktyg som aldrig sätter en spårningskaka och aldrig bygger en profil av en enskild besökare gör inte det som samtycket är till för att reglera, så det finns inget att be om lov för. Det här är en allmän princip, inte juridisk rådgivning för just din situation, men den förklarar varför så många bannerfria webbplatser inte tar genvägar." },
        { h: "Vad du faktiskt ser utan en banner" },
        { p: "Sidvisningar, vilka sidor besökarna kom in på och lämnade från, ungefär varifrån de kom, och vilka sidor som föregick ett formulärmeddelande. Det räcker för att avgöra om en ändring på en sida hjälpte eller stjälpte, vilket är precis den fråga ett småföretag behöver svar på." },
        { p: "Vad du inte får är en namngiven post som följer en besökare i veckor, eller möjligheten att rikta om annonsering till hen senare. För ett lokalt företag är det sällan de verktygen som avgör; vilken sida som gör en besökare till en förfrågan är det oftare." },
      ],
