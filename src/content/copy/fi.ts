  ...
  articleCopy: {
    "kotisivun-hinta": {
      ...
      body: [
        ...
        { h: "Kiinteä hinta vai tuntilaskutus" },
        { p: "Tuntilaskutus voi näyttää paperilla halvemmalta ja päätyä silti kalliimmaksi, koska jokainen lisäpyyntö on uusi rivi laskulla eikä kokonaissumma ole selvillä ennen kuin lasku tulee. Kiinteä hinta pakottaa toimittajan miettimään laajuuden etukäteen, mikä on juuri se keskustelu joka kannattaa käydä joka tapauksessa." },
        { p: 'Kiinteä hinta suojaa vain, jos laajuus on kirjattu kunnolla ylös. Yhden rivin tarjous ("uusi sivusto, 900 euroa") ei suojaa ketään. Kysy tarjousta, jossa on nimetty sivumäärä, kielet ja se, mikä lasketaan korjaukseksi ja mikä uudeksi ominaisuudeksi.' },
        { h: "Kulu joka näkyy vasta julkaisun jälkeen" },
        { p: "Tarjous ei lähes koskaan mainitse, mitä tapahtuu julkaisun jälkeisenä vuonna: verkkotunnus uusitaan vuosittain, ylläpidolla on jatkuva kulu, ja sisällönhallintajärjestelmä tarvitsee tietoturvapäivityksiä, tai siitä tulee helpoin reitti yrityksesi sisälle jollekin joka ei ole asiakas." },
        { p: "Staattinen sivusto poistaa suurimman osan tästä: ei lisäosia paikattavaksi, ei kirjautumissivua hyökättäväksi, ja muutaman tiedoston ylläpito maksaa murto-osan siitä mitä tietokantapohjainen alusta vaatii. Kannattaa kysyä suoraan, mitä toimittaja odottaa sinun maksavan toisena vuonna, ei vain mitä julkaisu maksaa." },
      ],
    ...
    "google-business-profiili": {
      ...
      body: [
        ...
        { h: "Kategoriat ja palvelut, ei vain perustiedot" },
        { p: "Pääkategoria ratkaisee, missä hauissa näyt ylipäätään, ja useimmat yritykset valitsevat suunnilleen sopivan sen sijaan että valitsisivat täsmälleen oikean. Rakennusliike, joka tekee pääasiassa kattoremontteja, kilpailee väärässä kategoriassa niistä kattohauista jotka oikeasti muuttuisivat asiakkaiksi." },
        { p: "Kategorian alla oleva palvelulista on lähes yhtä tärkeä. Kun jokainen palvelu on nimetty juuri niillä sanoilla joilla asiakas oikeasti hakee, Google saa enemmän vertailtavaa kuin pelkkä kategoria koskaan antaa." },
        { h: "Profiili vanhenee, jos kukaan ei katso sitä" },
        { p: "Poikkeusaukioloajat, tilapäinen sulkeminen, uusi palvelu: mikään näistä ei päivity itsestään. Ne yritykset jotka näkyvät oikein, ovat niitä jotka kohtelevat profiilia jatkuvasti ylläpidettävänä asiana, ei kerran tehtynä." },
        { p: "Myös kysymykset ja vastaukset -osio kannattaa tarkistaa. Kuka tahansa voi kirjoittaa sinne kysymyksen, ja kuka tahansa voi vastata siihen, myös joku jolla ei ole mitään tekemistä yrityksesi kanssa. Vastaamaton tai väärin vastattu kysymys näkyy listauksesi kärjessä siihen asti kun joku korjaa sen." },
      ],
    ...
    "sivuston-nopeus": {
      ...
      body: [
        ...
        { h: "Fontit ovat piilokulu" },
        { p: "Sivu, joka lataa fontin ulkopuoliselta palvelimelta, tekee kaiken muun päälle vielä yhden erillisen verkkopyynnön palvelimelle, jolla ei ole mitään tekemistä yrityksesi kanssa. Kun fontti ladataan omalta palvelimelta muun sivuston mukana, tämä pyyntö poistuu kokonaan ja selain pääsee näyttämään tekstin nopeammin." },
        { p: "Sama pätee upotettuihin lisäosiin: chat-kupla, ajanvarauskalenteri, some-syöte. Jokainen niistä on pieni verkkosivu joka latautuu omasi sisällä, ja jokaisella on oma nopeusbudjettinsa joka lisääntyy kokonaisaikaan riippumatta siitä pyysitkö sitä." },
        { h: "Miksi alusta ratkaisee" },
        { p: "Staattisista tiedostoista rakennettu sivu voidaan tarjoilla millisekunneissa, koska tietokantakyselyä tai palvelinpuolen renderöintiä ei tapahdu sillä hetkellä kun joku vierailee sivulla. Sisällönhallintajärjestelmä tekee saman työn joka ikisellä pyynnöllä, ellei sitä ole erikseen viritetty välimuistiin, eikä useimpia pienyritysten asennuksia ole." },
        { p: "Tämä ei ole väite jokaista järjestelmää vastaan. Se on peruste kysyä ennen rakentamisen alkua, mitä palvelimella oikeasti tapahtuu kun kävijä lataa sivun, koska se vastaus ennustaa latausaikaasi paremmin kuin melkein mikään muu tarjouksessa." },
      ],
    ...
    monikielisyys: {
      ...
      body: [
        ...
        { h: "Mitä oikeasti pitää kääntää" },
        { p: "Näkyvä leipäteksti on se ilmeinen osa. Lomakkeiden kenttänimet, virheilmoitukset, vahvistussähköpostit, kuvien alt-tekstit ja hakutuloksissa näkyvät sivuotsikot tarvitsevat saman käsittelyn. Sivusto joka vaihtaa kieltä otsikossa muttei yhteydenottolomakkeessa näyttää keskeneräiseltä, ei kansainväliseltä." },
        { p: "Hakukoneet käsittelevät jokaista kieliversiota omana sivunaan, joka pitää löytää omilla ehdoillaan. Se tarkoittaa, että myös metatiedot, ei vain leipäteksti, pitää kirjoittaa sille kielelle eikä kääntää sanasta sanaan suomenkielisestä versiosta." },
        { h: "Ruotsinruotsi ei ole sama asia tässä" },
        { p: "Suomenruotsissa on oma sanastonsa kaikelle mikä liittyy julkisiin palveluihin tai arkeen: Kela eikä Försäkringskassan, kotitalousvähennyksen termit joita Ruotsissa ei ole lainkaan. Teksti, jonka on kääntänyt tästä erosta tietämätön, kuulostaa vieraalta juuri sille yleisölle jolle se oli tarkoitettu." },
        { p: "Siksi toinen kieli ei ole tehtävä, jonka voi jättää yksin yleiskäännöstyökalulle. Se saa sanat oikein ja rekisterin väärin, ja suomenruotsalainen lukija huomaa sen heti." },
      ],
    ...
    "evasteeton-analytiikka": {
      ...
      body: [
        ...
        { h: "Mitä laki oikeasti vaatii" },
        { p: "Asetus ei vaadi banneria. Se vaatii suostumuksen ennen kuin muu kuin välttämätön käsittely alkaa, useimmiten seurantaevästeet jotka seuraavat kävijää sivustolta toiselle. Banneri on vain yleisin tapa hankkia se suostumus, ei ruksi joka pitää rastia riippumatta siitä mitä sivusto oikeasti tekee." },
        { p: "Työkalu, joka ei koskaan aseta seurantaevästettä eikä rakenna profiilia yksittäisestä kävijästä, ei tee sitä asiaa jota varten suostumus on olemassa, joten kysyttävää ei ole. Tämä on yleinen periaate, ei juridinen neuvo juuri sinun tilanteeseesi, mutta se selittää miksi niin moni ilman banneria toimiva sivusto ei oikaise mutkia." },
        { h: "Mitä ilman banneria näkee" },
        { p: "Sivunäytöt, mille sivuille kävijät saapuivat ja mistä he poistuivat, karkeasti mistä he tulivat, ja mitkä sivut edelsivät yhteydenottolomakkeen lähettämistä. Se riittää kertomaan, auttoiko vai haittasiko sivun muutos, ja se on juuri se kysymys johon pienyritys tarvitsee vastauksen." },
        { p: "Mitä ei saa, on nimetty tietue joka seuraa yhtä kävijää viikkojen ajan, tai mahdollisuus uudelleenkohdentaa mainontaa hänelle myöhemmin. Paikallisyritykselle nämä eivät useinkaan ole ne työkalut jotka ratkaisevat; se, mikä sivu muuttaa kävijän yhteydenotoksi, useimmiten on." },
      ],
