...
export const fi: Copy = {
  ...
  articleCopy: {
    "kotisivun-hinta": {
      ...
      body: [
        { p: "Ensimmäisen puhelun tavallisin kysymys on aina sama: mitä verkkosivut maksavat. Rehellinen vastaus on, että tarjoukset liikkuvat Suomessa muutamasta sadasta eurosta reilusti yli kymmeneen tuhanteen, eikä pelkkä luku kerro mitään ennen kuin tiedät mitä sen takana on." },
        { h: "Mitä eri hintaluokilla oikeasti saa" },
        { p: "Halvimmassa päässä ostat valmiin teeman, johon vaihdetaan logosi ja tekstisi. Se on nopeaa ja se toimii. Sivusto näyttää samalta kuin tuhat muuta, rakenne on se minkä teeman tekijä aikoinaan päätti, ja tekstit kirjoitat lähes aina itse." },
        { p: "Keskihinnassa maksat siitä, että joku miettii rakenteen sinun liiketoimintasi ympärille, kirjoittaa tekstit ja rakentaa sivuston niin että se latautuu nopeasti ja löytyy. Suurin osa työstä tässä luokassa ei ole koodia. Se on päätöksiä siitä mikä asia on millä sivulla ja missä järjestyksessä." },
        { p: "Kalleimmassa päässä on yleensä jotain toiminnallista: verkkokauppa, ajanvarausjärjestelmä tai liittymä johonkin järjestelmään jota jo käytät. Silloin hinta lakkaa riippumasta sivumäärästä ja alkaa riippua siitä, montako erikoistapausta pitää ratkaista." },
        { h: "Kolme kysymystä jotka erottavat tarjoukset" },
        { p: "Kysy kuka kirjoittaa tekstit. Tämä yksi kysymys selittää hintaeroista enemmän kuin mikään muu. Halpa tarjous olettaa yleensä että toimitat tekstit itse, mikä on täysin toimiva malli aina siihen hetkeen asti kun aikaa ei ole ja projekti seisoo kolme kuukautta." },
        { p: "Kysy kenen nimissä verkkotunnus ja lähdekoodi ovat. Verkkotunnuksen kuuluu olla sinun nimissäsi, ei toimittajan. Jos se on toimittajan, myöhempi vaihtaminen tarkoittaa palveluksen pyytämistä yritykseltä jonka juuri jätit." },
        { p: "Kysy mitä se maksaa vuodessa julkaisun jälkeen. Se luku puuttuu useimmista tarjouksista ja juuri se ratkaisee omistamisen todellisen hinnan." },
        { h: "Kulut jotka ilmestyvät toisena vuonna" },
        { p: "Fi-verkkotunnus maksaa pienen vuosimaksun. Palvelin maksaa jatkuvasti, vaikka mikään ei muuttuisi. Jos sivusto pyörii sisällönhallintajärjestelmällä, se tarvitsee tietoturvapäivityksiä, koska päivittämätön lisäosa on helpoin reitti yritykseesi sellaiselle joka ei ole asiakas." },
        { p: "Staattinen sivusto poistaa suurimman osan tästä: ei paikattavaa, ei kirjautumissivua johon hyökätä, ja muutaman tiedoston palvelinkulu on murto-osa tietokantapohjaisesta alustasta. Oli vastaus mikä tahansa, pyydä se kirjallisena ennen allekirjoitusta, ei sen jälkeen." },
        { h: "Kiinteä hinta vai tuntilasku" },
        { p: "Tuntitarjous voi näyttää paperilla halvemmalta ja tulla lopulta kalliimmaksi, koska jokainen lisätoive on uusi rivi eikä kokonaissummaa tiedä kukaan ennen laskua. Kiinteä hinta pakottaa toimittajan miettimään sisällön läpi ennen aloitusta, ja juuri se keskustelu kannattaa käydä joka tapauksessa." },
        { p: "Koukku on siinä, että kiinteä hinta suojaa vain jos sisältö on kirjattu. Yhden rivin tarjous, uudet verkkosivut, 900 euroa, ei suojaa ketään. Pyydä määrittely joka kertoo sivumäärän, kielet, mikä lasketaan korjaukseksi ja mikä uudeksi työksi." },
        { h: "Miltä reilu tarjous näyttää" },
        { p: "Se nimeää sivut. Se kertoo kuka kirjoittaa tekstit ja kuka toimittaa kuvat. Se kertoo kielet. Se kertoo montako korjauskierrosta kuuluu hintaan ja mitä tapahtuu niiden jälkeen. Se kertoo vuosikulun julkaisun jälkeen. Se kertoo kenen nimissä verkkotunnus, sisältö ja koodi ovat." },
        { p: "Jos tarjous tekee nuo asiat, voit verrata sitä rehellisesti toiseen samanlaiseen. Jos ei tee, vertailet kahta lukua jotka kuvaavat eri asioita." },
        { h: "Yksi asia josta kannattaa maksaa" },
        { p: "Hintaluokasta riippumatta maksa rakennekeskustelusta. Ero sivuston joka tuottaa yhteydenottoja ja sivuston joka vain on olemassa välillä on harvoin ulkoasu. Se on siinä, onko joku selvittänyt mitä asiakkaan pitää nähdä ja missä järjestyksessä ennen kuin hän päättää soittaa." },
      ],
    ...
    "google-business-profiili": {
      ...
      body: [
        { p: "Paikalliselle yritykselle Google Business -profiili on usein arvokkaampi kuin verkkosivut, koska se on se mikä näkyy karttatuloksissa ennen kuin kukaan vierittää tavallisiin linkkeihin. Se on myös ilmainen, mikä tekee sen jättämisestä puolitiehen kalliin tavan." },
        { h: "Google kertoo itse mihin sijoitus perustuu" },
        { p: "Google nimeää paikallisille tuloksille kolme tekijää: osuvuus, etäisyys ja tunnettuus. Toimipaikkaa et voi siirtää, joten etäisyys on kiinteä. Osuvuus on se miten hyvin profiilisi vastaa sitä mitä joku haki. Tunnettuus on se miten tunnetulta yritys vaikuttaa, mihin kuuluvat arviot ja maininnat muualla." },
        { p: "Käytännössä lähes kaikki työ mitä voit tehdä on osuvuudessa ja tunnettuudessa, ja molemmat saa kuntoon yhdessä iltapäivässä ja pidettyä sen jälkeen yllä." },
        { h: "Pääkategoria tekee raskaimman työn" },
        { p: "Merkittävin yksittäinen kenttä on pääkategoria. Autokorjaamoksi merkitty yritys käyttäytyy eri tavalla kuin autotarvikeliikkeeksi merkitty, ja väärä valinta sulkee sinut hiljaisesti pois juuri niistä hauista joista välität." },
        { p: "Valitse pääkategoriaksi se mitä pääasiassa teet ja lisää loput toissijaisiksi kategorioiksi. Katso mitä alueesi kolme kärkiyritystä käyttävät, koska se lista kertoo mitä kategorioita Google oikeasti yhdistää siihen hakuun." },
        { h: "Kentät jotka useimmilta jäävät tyhjiksi" },
        { p: "Palvelut, kukin lyhyellä kuvauksella. Aukioloajat, mukaan lukien poikkeusajat juhannukseksi, jouluksi ja niiksi viikoiksi kun olet kiinni, koska profiili joka väittää olevansa auki kun olet kiinni tuottaa yhden vihaisen arvion kerrallaan." },
        { p: "Valokuvat oikeista tiloista, tiimistä ja työn jäljestä, ei kuvituskuvaa. Osoite täsmälleen samassa muodossa kuin sivustollasi ja laskuillasi. Puhelinnumero josta vastaa ihminen. Linkki juuri siihen sivuun joka vastaa palvelua, ei aina etusivulle." },
        { h: "Arviot, ostamatta yhtäkään" },
        { p: "Pyydä sillä hetkellä kun asiakas on tyytyväisimmillään, yleensä kun hän noutaa työn tai maksaa. Pyydä kasvotusten tai lyhyellä linkillä jälkikäteen. Älä tarjoa mitään vastineeksi, älä osta arvioita äläkä pyydä koko listalta kerralla." },
        { p: "Vastaa jokaiseen arvioon, myös huonoihin, lyhyesti ja väittelemättä. Vastaus ei ole valittajalle. Se on seuraavalle asiakkaalle joka lukee sen ja miettii oletko sellainen yritys joka hoitaa ongelman rauhallisesti." },
        { h: "Pidä nimi, osoite ja numero samanlaisina kaikkialla" },
        { p: "Yrityksen nimen, osoitteen ja puhelinnumeron pitää olla täsmälleen samat profiilissa, sivustolla, laskuilla ja jokaisessa hakemistossa joka listaa sinut. Ei Katu 5 yhdessä paikassa ja Katu 5 A toisessa. Epäjohdonmukaisuus vaikeuttaa Googlen varmuutta siitä että kyse on samasta yrityksestä." },
        { h: "Mitä tarkistat kerran kuussa" },
        { p: "Neljä asiaa, ja siihen menee kymmenen minuuttia. Ovatko aukioloajat yhä oikein, poikkeukset mukaan lukien. Onko uusiin arvioihin jäänyt vastaamatta. Onko joku ehdottanut muutosta tietoihisi, koska kuka tahansa voi ehdottaa ja Google hyväksyy joskus. Ovatko kuvat yhä ajan tasalla." },
        { h: "Mitä se ei tee" },
        { p: "Täydellinenkään profiili ei nosta sinua ensimmäiseksi, jos kolme kilpailijaa on lähempänä hakijaa ja niillä on tuplasti arvioita. Se saa sinut mukaan kilpaan, ja juuri se osa on sinun hallinnassasi. Jos joku lupaa taatun sijan karttatuloksissa, hän lupaa jotain mitä ei voi toimittaa." },
      ],
    ...
    "sivuston-nopeus": {
      ...
      category: "Tekniikka",
      body: [
        { p: "Nopeus ei ole tekninen yksityiskohta. Se on se määrä ihmisiä, jotka jaksavat odottaa sivuasi sen sijaan että palaisivat hakutuloksiin, ja poistuvat ovat juuri niitä jotka eivät tunteneet yritystäsi ennestään." },
        { h: "Mitä Google oikeasti mittaa" },
        { p: "Google julkaisee käyttämänsä raja-arvot, joten arvailuun ei ole tarvetta. Largest Contentful Paint eli hetki jolloin pääsisältö ilmestyy näkyviin pitäisi olla alle 2,5 sekuntia. Interaction to Next Paint eli viive ennen kuin sivu reagoi napautukseen pitäisi olla alle 200 millisekuntia. Cumulative Layout Shift eli se miten paljon sivu hyppii latautuessaan pitäisi jäädä alle 0,1." },
        { p: "Nämä kolme lukua kerätään oikeilta kävijöiltä Chromessa, ei laboratoriotestistä. Siksi sivusto voi saada hyvät pisteet kehittäjän koneella ja huonot kentällä. Kenttädata on se joka ratkaisee." },
        { h: "Näin tarkistat sen itse viidessä minuutissa" },
        { p: "Avaa pagespeed.web.dev, liitä osoitteesi ja lue ensin mobiilivälilehti, koska siellä valtaosa kävijöistäsi on. Jos sivun ylälaidassa näkyy kenttädataa, se on oikeita Chrome-käyttäjiä sinun sivustollasi, ja juuri siihen kannattaa luottaa. Sen alla oleva laboratoriopistemäärä on diagnoosityökalu, ei tuomio." },
        { p: "Tee sitten sama käsin: avaa sivustosi puhelimella mobiiliverkossa, ei kotisi wifissä, ja kylmältä käynnistykseltä. Jos joudut odottamaan, asiakaskin joutuu, eikä mikään pistemäärä muuta sitä." },
        { h: "Kuvat ovat lähes aina syy" },
        { p: "Tavallisin syy ei ole palvelin vaan valokuvat. Suoraan puhelimen kamerasta otettu kuva voi olla neljä tai viisi megatavua, ja sivulla niitä voi olla kymmenen. Skaalattuna siihen kokoon jossa se oikeasti näytetään ja tallennettuna WebP-muotoon sama kuva on murto-osa siitä, eikä eroa näe silmällä." },
        { p: "Kolme korjausta kattaa suurimman osan. Vie kuva ulos siinä leveydessä jossa se todella näytetään, ei leveämpänä. Käytä WebP- tai AVIF-muotoa kameran JPEG-tiedoston sijaan. Anna jokaiselle kuvalle leveys ja korkeus koodiin, jotta selain varaa tilan eikä teksti hyppää kun kuva saapuu. Juuri sitä hyppimistä Cumulative Layout Shift mittaa." },
        { h: "Fontit, lisäosat ja kaikki muualta ladattava" },
        { p: "Sivu joka hakee fonttinsa ulkopuoliselta palvelimelta tekee ylimääräisen pyynnön yritykselle jolla ei ole mitään tekemistä sinun kanssasi, eikä teksti yleensä piirry ennen kuin se on valmis. Kun fontti tarjoillaan omalta palvelimelta, pyyntö poistuu kokonaan." },
        { p: "Sama koskee kaikkea upotettua: chat-kuplaa, ajanvarauskalenteria, some-syötettä, karttaa. Jokainen niistä on pieni verkkosivu joka latautuu sinun sivusi sisällä, ja jokaisen oma budjetti lisätään sinun kokonaisaikaasi riippumatta siitä käyttääkö kävijä sitä. Kartta joka latautuu vasta klikkauksesta ei maksa mitään sille joka ei klikkaa." },
        { h: "Miksi alusta määrää katon" },
        { p: "Staattisista tiedostoista rakennettu sivu voidaan tarjoilla millisekunneissa, koska tietokantakyselyä tai palvelinpuolen renderöintiä ei tapahdu sillä hetkellä kun joku vierailee. Sisällönhallintajärjestelmä tekee saman työn jokaisella pyynnöllä, ellei sitä ole erikseen viritetty välimuistiin, eikä useimpia pienyritysten asennuksia ole." },
        { p: "Tämä ei ole väite jokaista järjestelmää vastaan. Se on peruste kysyä ennen rakentamisen alkua, mitä palvelimella oikeasti tapahtuu kun kävijä lataa sivun. Se vastaus ennustaa latausaikaasi paremmin kuin melkein mikään muu tarjouksessa." },
        { h: "Mihin ei kannata käyttää aikaa" },
        { p: "Sadan pisteen jahtaaminen ei kannata. Ero 92:n ja 100:n välillä on asiakkaalle näkymätön, kun taas ero neljän ja yhden sekunnin välillä on koko juttu. Korjaa kuvat, poista upotukset joita et käytä, tarjoile fontit itse, ja lopeta siihen." },
        { p: "Nopeus vaikuttaa myös hakukonesijoitukseen suoraan, joten korjaus maksaa itsensä takaisin kahdesti: useampi tulija jää, ja useampi ylipäätään löytää perille." },
      ],
    ...
    monikielisyys: {
      ...
      category: "Kasvu",
      body: [
        { p: "Lähes jokainen suomalainen pienyritys julkaisee sivustonsa vain suomeksi. Se on ymmärrettävä oletus, ja se jättää kaksi ryhmää tavoittamatta: ruotsinkieliset ja ne englanninkieliset jotka asuvat Suomessa tai vierailevat täällä. Molemmat hakevat jo nyt sitä mitä myyt." },
        { h: "Milloin ruotsi kannattaa ja milloin ei" },
        { p: "Ruotsi on Suomen virallinen kieli, eivätkä puhujat jakaudu tasaisesti. He ovat keskittyneet rannikolle: Pohjanmaalle, Turun saaristoon ja osiin Uuttamaata. Jos toimit noilla alueilla, ruotsinkielinen versio maksaa itsensä takaisin. Jos pidät korjaamoa sisämaassa ilman yhtäkään ruotsinkielistä asiakasta, se ei maksa, eikä sitä pitäisi sinulle myydä." },
        { p: "Testi on yksinkertainen. Asioivatko alueesi ihmiset arjessaan ruotsiksi. Jos kyllä, kieli ei ole koriste vaan ero sen välillä että sinut otetaan harkintaan tai ei löydetä lainkaan." },
        { h: "Englanti on eri asia" },
        { p: "Englanti voittaa harvoin paikallisen asiakkaan joka osaa jo suomea. Se voittaa ne jotka eivät pysty lukemaan suomenkielistä sivua lainkaan: maahan muuttaneet, opiskelijat, kausityöntekijät, matkailijat ja kasvava joukko ihmisiä jotka tekevät Suomessa työtä englanniksi. Ravintolalle, korjaamolle, klinikalle tai tilitoimistolle yliopistokaupungissa se joukko ei ole pieni." },
        { h: "Miksi yksi sivu ja käännösnappi ei riitä" },
        { p: "Selaimen käännöspainike auttaa kävijää joka on jo löytänyt sinut. Se ei tee mitään sille joka ei koskaan löytänyt, koska ruotsiksi tai englanniksi ei ole ylipäätään mitään mitä hakukone voisi indeksoida." },
        { p: "Jokainen kieli tarvitsee oman osoitteensa. Ei yhtä sivua joka vaihtaa tekstin, vaan stellarstack.fi kautta sv kautta ja stellarstack.fi kautta en kautta, kummallakin oma otsikko, oma kuvaus ja oma leipäteksti. Juuri se tekee sivusta ylipäätään kelvollisen näkymään, kun joku hakee sillä kielellä." },
        { h: "Tekninen osuus lyhyesti" },
        { p: "Kolme asiaa ratkaisee. Jokaisella versiolla on oma osoite. Jokainen sivu ilmoittaa kielensä koodissa, jotta sekä ruudunlukija että hakukone tietävät mitä lukevat. Ja versiot osoittavat toisiinsa hreflang-linkeillä, mikä kertoo Googlelle että kyse on samasta sivusta eri kielillä eikä sisällöstä joka kilpailee itsensä kanssa." },
        { p: "Hakukoneet käsittelevät jokaista kieliversiota sivuna joka löydetään omilla ehdoillaan. Siksi myös metatiedot on kirjoitettava sille kielelle, ei vain leipätekstiä, eikä käännettävä sanasta sanaan suomesta." },
        { h: "Kääntäminen ei ole lokalisointia" },
        { p: "Suoraan suomesta käännetty ruotsinkielinen sivu kuulostaa käännökseltä, ja lukija huomaa sen yhden virkkeen sisällä. Termien pitää olla niitä joita Suomessa oikeasti käytetään: FPA eikä Försäkringskassan, ja suomalaiset laitokset niillä nimillä joita Suomen ruotsinkieliset niistä käyttävät." },
        { p: "Tällä on enemmän merkitystä kuin miltä kuulostaa. Väärin tehtynä se kertoo että sivu on tuotettu hakukoneille eikä lukijalle, mikä on päinvastainen vaikutelma kuin se josta maksoit." },
        { h: "Mitä kannattaa kääntää ensin" },
        { p: "Ei kaikkea. Aloita sivuista jotka ratkaisevat ostopäätöksen: etusivu, ne palvelut joita oikeasti haluat lisää, ja yhteystiedot. Jätä blogi suomeksi kunnes on syy tehdä toisin." },
        { p: "Viiden sivun sivusto kolmella kielellä voittaa kahdenkymmenen sivun sivuston yhdellä, jos ne viisi sivua ovat ne jotka asiakas lukee ennen soittamista." },
        { h: "Entä hinta" },
        { p: "Kaksi lisäkieltä ei kaksinkertaista työtä, kun kielikerros on rakennettu perustaan alusta asti. Ne suunnilleen kaksinkertaistavat sen, jos ne liimataan päälle kahden vuoden päästä, koska siihen mennessä rakenne, navigaatio ja jokainen sisäinen linkki olettavat yhtä kieltä." },
        { p: "Juuri se on todellinen peruste päättää asia alussa, vaikka julkaisisit ensimmäisenä päivänä vain suomeksi: rakenna niin että kaksi muuta voi lisätä myöhemmin rakentamatta sivustoa uusiksi niiden ympärille." },
      ],
    ...
    "evasteeton-analytiikka": {
      ...
      category: "Mittaus",
      body: [
        { p: "Useimmilla pienyritysten sivustoilla on evästebanneri, koska joku sanoi että pitää olla, ja banneri tuhoaa sitten hiljaa suuren osan siitä mittauksesta jota se asennettiin suojaamaan. Tästä on ulospääsy, ja se on yksinkertaisempi kuin banneri." },
        { h: "Mistä bannerivaatimus oikeasti tulee" },
        { p: "Velvoite ei koske tietosuojaa yleisesti. Se tulee säännöistä jotka koskevat tiedon tallentamista kävijän laitteelle, ja Suomessa ne ovat sähköisen viestinnän lainsäädännössä tietosuoja-asetuksen rinnalla. Sellaisen tallentaminen mikä ei ole palvelun kannalta välttämätöntä, ja analytiikkaeväste on juuri sitä, vaatii suostumuksen." },
        { p: "Lue sama toisin päin, niin vastaus ilmestyy. Vaatimus kiinnittyy tallentamiseen laitteelle. Mittaus joka ei tallenna mitään ei laukaise sitä." },
        { h: "Mitä kysymisestä menettää" },
        { p: "Jokainen kieltäytyvä kävijä katoaa luvuistasi, eivätkä kieltäytyjät ole satunnaisotos. Käteen jää raportti joka kuvaa sitä osajoukkoa joka suhtautuu seurantaan myönteisimmin, ja sen perusteella tehdään päätöksiä kaikkien kävijöiden puolesta." },
        { p: "Bannerista maksat myös yhteydenotoissa. Se peittää sivun juuri sillä hetkellä kun ensikertalainen päättää jääkö hän, ja pienellä ruudulla se peittää suhteessa enemmän." },
        { h: "Mitä evästeetön mittaus antaa" },
        { p: "Sivunäytöt sivuittain. Mistä kävijät tulivat: hausta, linkistä, mainoksesta vai suoraan kirjoittamalla. Millä laitteella. Mistä maasta. Moniko pääsi yhteystietosivulle ja moniko lähetti lomakkeen." },
        { p: "Se on rehellisesti kaikki mitä pienyritys tarvitsee mihinkään päätökseen. Kolme vastaamisen arvoista kysymystä ovat moniko kävi, mistä he tulivat ja moniko otti yhteyttä. Kaikki muu tavallisella koontinäytöllä on koristetta." },
        { h: "Mitä se ei anna" },
        { p: "Ei yksittäisten kävijöiden polkuja eikä tunnistetta yli käyntikertojen, joten et voi sanoa että juuri tämä ihminen palasi kolmesti ennen ostoa. Ei uudelleenmarkkinoinnin kohderyhmiä, koska ne perustuvat juuri siihen tunnisteeseen jota et halunnut tallentaa." },
        { p: "Jos liiketoimintasi nojaa uudelleenmarkkinointiin, tarvitset suostumusvirran ja bannerin, ja se on täysin kelvollinen vaihtokauppa. Tee se harkiten äläkä oletuksena." },
        { h: "Mitä vaihtoehtoja on" },
        { p: "Plausible, Fathom ja Umami ovat analytiikkatyökaluja jotka on rakennettu evästeettömiksi alusta asti ja joita voi käyttää palveluna tai omalla palvelimella. Matomon voi ajaa omalla palvelimella ja määrittää ilman evästeitä. Jokainen pitää datan Euroopassa jos valitset EU-palvelimen, mikä poistaa erillisen kysymyksen siirroista EU:n ulkopuolelle." },
        { p: "Käytännön erot ovat pienyritykselle pieniä. Valitse yksi, pidä se, ja käytä huomio siihen mitä luvuilla teet." },
        { h: "Mittaa se mikä on rahan arvoista" },
        { p: "Kävijämäärä ei ole tavoite. Yhteydenotot ovat. Siksi tärkein asetus on tavoitteet: lähetetty yhteydenottolomake, puhelinnumeron klikkaus, sähköpostiosoitteen klikkaus. Ne kolme kertovat tekeekö sivu tehtävänsä." },
        { p: "Merkitse sitten kampanjasi johdonmukaisesti, jottei mainos, uutiskirje ja painettu QR-koodi saavu kaikki suorana liikenteenä. Ilman sitä jokainen kanavavertailu on arvailua." },
        { h: "Yksi asia tälle viikolle" },
        { p: "Avaa analytiikkasi ja yritä vastata yhteen kysymykseen: mikä sivu tuotti kymmenen viimeisintä yhteydenottoa. Jos vastaus ei näy minuutissa, mittaus on rakennettu raportointia eikä päättämistä varten, ja se kannattaa korjata ennen kuin ostat lisää liikennettä." },
      ],
